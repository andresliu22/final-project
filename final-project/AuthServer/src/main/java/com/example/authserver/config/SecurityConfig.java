...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/auth/*").permitAll()  // all users are permitted
                .antMatchers("/auth/login", "/actuator/**").permitAll()  // all users are permitted

                .antMatchers("/auth/all", "/auth/info").hasRole("USER")
                .antMatchers("/auth/token").hasRole("ADMIN")
